...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className="flex items-center h-[60px] bg-white font-sans border-b border-gray-100 z-20 relative">
                <div className="max-w-6xl mx-auto p-4 w-full flex items-center gap-8">
                    {/* Logo */}
                    <div
